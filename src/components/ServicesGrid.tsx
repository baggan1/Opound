...
import { Search, Zap, Users, MessageSquare } from 'lucide-react';
...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, engagement, icon }) => (
    <div className="bg-slate-800/20 border border-slate-800/50 p-10 rounded-[2rem] hover:border-emerald-500/40 transition-all group hover:bg-slate-800/40 cursor-default flex flex-col">
        ...
        <p className="text-slate-400 leading-relaxed font-light mb-6 flex-grow">{description}</p>
